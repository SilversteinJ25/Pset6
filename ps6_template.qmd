...
for index, full_row in full_waze_data.iterrows():
    matching_row = crosswalk[(crosswalk['type'] == full_row['type']) & (crosswalk['subtype'] == full_row['subtype'])]
    
    if not matching_row.empty:
        updated_row = update_subtypes(matching_row.iloc[0])  
        full_waze_data.at[index, 'updated_type'] = updated_row['updated_type']
        full_waze_data.at[index, 'updated_subtype'] = updated_row['updated_subtype']
        full_waze_data.at[index, 'updated_subsubtype'] = updated_row['updated_subsubtype']
    else:
        full_waze_data.at[index, 'updated_type'] = full_row['type']
        full_waze_data.at[index, 'updated_subtype'] = 'unclassified'
        full_waze_data.at[index, 'updated_subsubtype'] = 'unclassified'

print(full_waze_data)
```
